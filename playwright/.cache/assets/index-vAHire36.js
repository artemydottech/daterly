const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BE4DMema.js","assets/Spinner-ra9hIxQv.js","assets/ControlledDatePicker-ig9EY8zT.js","assets/CustomTriggerDatePicker-mBC_AkZ3.js","assets/index-DJ_GuejU.js","assets/ControlledDateRangePicker-bF7SFlQz.js","assets/RangeSelectionWrapper-mLwmNU22.js"])))=>i.map(i=>d[i]);
...
const _Users_artemijzverev_Desktop_GitHub_datepicker_src_components_DatePicker_DatePicker = () => __vitePreload(() => import('./index-BE4DMema.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.DatePicker);
const _Users_artemijzverev_Desktop_GitHub_datepicker_tests_e2e_stories_ControlledDatePicker_ControlledDatePicker = () => __vitePreload(() => import('./ControlledDatePicker-ig9EY8zT.js'),true              ?__vite__mapDeps([2,1,0]):void 0).then((mod) => mod.ControlledDatePicker);
const _Users_artemijzverev_Desktop_GitHub_datepicker_tests_e2e_stories_CustomTriggerDatePicker_CustomTriggerDatePicker = () => __vitePreload(() => import('./CustomTriggerDatePicker-mBC_AkZ3.js'),true              ?__vite__mapDeps([3,1,0]):void 0).then((mod) => mod.CustomTriggerDatePicker);
const _Users_artemijzverev_Desktop_GitHub_datepicker_src_components_DateRangePicker_DateRangePicker = () => __vitePreload(() => import('./index-DJ_GuejU.js'),true              ?__vite__mapDeps([4,1]):void 0).then((mod) => mod.DateRangePicker);
const _Users_artemijzverev_Desktop_GitHub_datepicker_tests_e2e_stories_ControlledDateRangePicker_ControlledDateRangePicker = () => __vitePreload(() => import('./ControlledDateRangePicker-bF7SFlQz.js'),true              ?__vite__mapDeps([5,1,4]):void 0).then((mod) => mod.ControlledDateRangePicker);
const _Users_artemijzverev_Desktop_GitHub_datepicker_tests_e2e_stories_RangeSelectionWrapper_RangeSelectionWrapper = () => __vitePreload(() => import('./RangeSelectionWrapper-mLwmNU22.js'),true              ?__vite__mapDeps([6,1,4]):void 0).then((mod) => mod.RangeSelectionWrapper);
__pwRegistry.initialize({ _Users_artemijzverev_Desktop_GitHub_datepicker_src_components_DatePicker_DatePicker,
  _Users_artemijzverev_Desktop_GitHub_datepicker_tests_e2e_stories_ControlledDatePicker_ControlledDatePicker,
  _Users_artemijzverev_Desktop_GitHub_datepicker_tests_e2e_stories_CustomTriggerDatePicker_CustomTriggerDatePicker,
  _Users_artemijzverev_Desktop_GitHub_datepicker_src_components_DateRangePicker_DateRangePicker,
  _Users_artemijzverev_Desktop_GitHub_datepicker_tests_e2e_stories_ControlledDateRangePicker_ControlledDateRangePicker,
  _Users_artemijzverev_Desktop_GitHub_datepicker_tests_e2e_stories_RangeSelectionWrapper_RangeSelectionWrapper });

export { React as R, requireReact as a, getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-vAHire36.js.map
