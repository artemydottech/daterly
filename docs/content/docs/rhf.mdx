...
- [С Zod](/ru/docs/recipes/rhf-zod) — рекомендованный стек
- [С Joi](/ru/docs/recipes/rhf-joi) — для legacy-проектов
- [С shadcn/ui Form](/ru/docs/recipes/shadcn-form) — встраивание в shadcn `<FormField>`
