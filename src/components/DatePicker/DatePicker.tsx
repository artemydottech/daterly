...
export type DatePickerTimePickerType = 'drum' | 'input';
...
export function DatePicker({
  ...
  return (
    <div
      ref={containerRef}
      className={['daterly', `daterly--${size}`, className]
        .filter(Boolean)
        .join(' ')}
              ...
              <>
                <div className="daterly__popover-body">
                  ...
                  <div className="daterly__popover-time">
                    <TimePanel
                      value={
                        selected && isValid(selected) ? selected : draftTime
                      }
              ...
              <>
                ...
                <div className="daterly__popover-footer daterly__popover-footer--time">
                  <label className="daterly__time-field">
                    <span className="daterly__time-field-label">Время</span>
                    <TimeInput
                      value={
                        selected && isValid(selected) ? selected : draftTime
                      }
